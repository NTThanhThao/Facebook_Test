...
1.  **Đăng nhập:** Xác minh truy cập hệ thống.
...
* **Phân vùng tương đương:** Chia dữ liệu thành các nhóm hợp lệ và không hợp lệ.
...
| File/Tài liệu | Mô tả | Vai trò |
| :--- | :--- | :--- |
| **Test Scenario & Case** | Bộ Test Case chi tiết (với Steps, Expected Result...) | Chứng minh kỹ năng **viết tài liệu** và **tư duy logic**. |
| **Bug Report Template** | Mẫu báo cáo lỗi tiêu chuẩn, phân biệt **Severity** và **Priority**. | Chứng minh hiểu biết về **quy trình quản lý lỗi (Bug Management)**. |
| **Test Types & Scope** | Bảng tổng hợp các loại test (Functional, UI/UX, Performance, Compatibility...). | Chứng minh **tầm nhìn tổng quát** về chiến lược kiểm thử. |
| **Checklist & Mindmap** | Công cụ hỗ trợ tư duy và kiểm thử nhanh. | Chứng minh kỹ năng **phân tích** và **quản lý thông tin**. |
